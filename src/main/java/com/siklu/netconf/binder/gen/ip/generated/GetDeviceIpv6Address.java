 ...
 *       &lt;sequence>
 *         &lt;element name="assigned-name" type="{http://siklu.com/yang/tg/types}node-assigned-name"/>
...
public class GetDeviceIpv6Address
    extends RpcOperationType
{

    @XmlElement(name = "assigned-name", namespace = "http://siklu.com/yang/tg/ip", required = true)
